...
public class KontonummerValidator extends StringNumberValidator {
    ...
    /**
     * Returns an object that represents a Kontonummer. The checksum of the supplied kontonummer
     * is changed to a valid checksum if the original kontonummer has an invalid checksum.
     * 
     * @param kontonummer
     * 			A String containing a Kontonummer
     * @return A Kontonummer instance
     * @throws IllegalArgumentException
 	 * thrown if String contains an invalid Kontonummer, ie. a number which for one cannot
