...
public class NorwegianDateUtil {
    ...
    * <p/>
    * Example 1:<br/>
    * - Add 5 working days to Wednesday 21.03.2007 -> Yields Wednesday 28.03.2007.
    * (skipping saturday and sunday)<br/>
    * <p/>
    * Example 2:<br/>
    * - Add 5 working days to Wednesday 04.04.2007 (day before easter-long-weekend) ->
    * yields Monday 16.04.2007 (skipping 2 weekends and 3 weekday holidays).
    *
   ...
   /**
    * Will check if the given date is a working day. That is check if the
    * given date is a weekend day or a national holiday.
    *
   ...
   public static Date[] getHolidays(int year) {
      ...
      Date[] dates = (Date[]) days.toArray(new Date[days.size()]);
      Arrays.sort(dates);
      return dates;
   }
    ...
    * <a href="http://no.wikipedia.org/wiki/P%C3%A5skeformelen">Wikipedia - Påskeformelen</a>
    *
    ...
    *
    * @param cal   The Calendar representing the first date.
    * @param other The Calendar representing the second date.
    ...
    *
    * @param cal   The Calendar object representing date to check.
    * @param date  The date.
