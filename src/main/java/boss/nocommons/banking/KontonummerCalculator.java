...
//	private static final int REGISTERNUMMER_NUM_DIGITS = 4;
    ...
    private static List getKontonummerListUsingGenerator( KontonummerDigitGenerator generator, int length ) {
    ...
    /**
     * Returns a List with random but syntactically valid Kontonummer instances for a given AccountType.
     * 
     * @param accountType
     * 			A String representing the AccountType to use for all Kontonummer instances
     * @param length
     * 			Specifies the number of Kontonummer instances to create in the returned List
     * @return A List with Kontonummer instances
     */
    public static List getKontonummerListForAccountType( String accountType, int length ) {
    ...
    /**
     * Returns a List with random but syntactically valid Kontonummer instances for a given Registernummer.
     * 
     * @param registernummer
     * 			A String representing the Registernummer to use for all Kontonummer instances
     * @param length
     * 			Specifies the number of Kontonummer instances to create in the returned List
     * @return A List with Kontonummer instances
     */
    public static List getKontonummerListForRegisternummer( String registernummer, int length ) {
    ...
    /**
     * Returns a List with completely random but syntactically valid Kontonummer instances.
     * 
     * @param length
     * 		Specifies the number of Kontonummer instances to create in the returned List
     * 
     ...
     */
    public static List getKontonummerList( int length ) {
