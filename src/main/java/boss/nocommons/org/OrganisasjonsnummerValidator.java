...
public class OrganisasjonsnummerValidator extends StringNumberValidator {
     ...
     */
    public static Organisasjonsnummer getOrganisasjonsnummer(
            String organisasjonsnummer) throws IllegalArgumentException {
    ...
    /**
     * Returns an object that represents a Organisasjonsnummer. The checksum of the supplied organisasjonsnummer
     * is changed to a valid checksum if the original organisasjonsnummer has an invalid checksum.
     * 
     * @param organisasjonsnummer
     * 			A String containing a Organisasjonsnummer
     * @return A Organisasjonsnummer instance
     * @throws IllegalArgumentException
 	 * thrown if String contains an invalid Organisasjonsnummer, ie. a number which for one cannot
    ...
    static void validateChecksum(String organisasjonsnummer) {
        ...
        if (k1 != onr.getChecksumDigit()) {
            throw new IllegalArgumentException(ERROR_INVALID_CHECKSUM
                    + organisasjonsnummer);
        }
    }
