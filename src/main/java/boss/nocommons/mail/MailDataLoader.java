 ...
 * provides a method that loads data from a file included in the jar, and another method
 * that loads data from a given InputStream. 
...
public class MailDataLoader {
    ...
    public static void loadFromInputStream(InputStream is) throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            // add to poststedMap
            List postnummerList = new ArrayList();
            if (poststedMap.containsKey(ps)) {
                postnummerList = (List) poststedMap.get(ps);
            }
